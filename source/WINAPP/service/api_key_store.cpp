...
bool ApiKeyStore::GenerateApiMd(const std::string& service_url) const {
    ...
    f << "> Auto-generated by TelemetryApp v" << TelemetryApp::APP_VERSION << " on " << now << "  \n";
    f << "> Capability revision: `" << TelemetryApp::CAPABILITY_REVISION << "`  \n";
    f << "> Docs bundle: " << TelemetryApp::DOCS_BUNDLE << "  \n";
